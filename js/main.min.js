...
jQuery(document).ready(function ($) {
    ...
    if (popupChatWindow.length) {
        ...
        var chatWindowToggleCloseIcon = $(".close-chat-window");
    ...
    */
    ...
    var headerSearchBar = $(".header__search");
    ...
    */
    if ($(window).width() < 576) {
        var carouselMobile1 = $("#carousel-mobile-1");
        var carouselMobile2 = $("#carousel-mobile-2");
        ...
        carouselMobile1.owlCarousel({
            ...
            nav: true,
            center: true,
            navText: ['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 477.175 477.175"><path d="M145.188 238.575l215.5-215.5c5.3-5.3 5.3-13.8 0-19.1s-13.8-5.3-19.1 0l-225.1 225.1c-5.3 5.3-5.3 13.8 0 19.1l225.1 225c2.6 2.6 6.1 4 9.5 4s6.9-1.3 9.5-4c5.3-5.3 5.3-13.8 0-19.1l-215.4-215.5z"/></svg>', '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129"><path d="M40.4 121.3c-.8.8-1.8 1.2-2.9 1.2s-2.1-.4-2.9-1.2c-1.6-1.6-1.6-4.2 0-5.8l51-51-51-51c-1.6-1.6-1.6-4.2 0-5.8 1.6-1.6 4.2-1.6 5.8 0l53.9 53.9c1.6 1.6 1.6 4.2 0 5.8l-53.9 53.9z"/></svg>']
        });
